...
# Cortisol saliva & serum predictors are problematic

# Cortisol saliva will go, since the cc is less accurate
...
comp_stat$term <- rownames(table)

#Regression equation:

sprintf("Y = %.3g + %.3g*age + %.3g*sex + %.3g*STAI trait + %.3g*pain catastrophising + %.3g*cortisol_serum + %.3g*mindfulness", comp_stat[1,1], comp_stat[2,1], comp_stat[3,1], comp_stat[4,1], comp_stat[5,1], comp_stat[6,1], comp_stat[7,1])
